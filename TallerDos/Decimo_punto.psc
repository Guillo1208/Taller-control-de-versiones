Proceso Decimo_punto
	...
	Segun opcion Hacer
		1:
			escribir "Hola Sr ", titular , " acontinuacion ingresa el valor a consignar en la cuenta";
			leer ingreso;
		...
		2:
			escribir "Hola Sr ", titular ," acontinuacion ingresa el valor a retirar de la cuenta Recuerda que tienes disponible $",cantidad;
			leer retiro;
